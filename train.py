...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "runs/train/tunnelcrack7/weights/best.pt")
    parser.add_argument("--cfg", type=str, default=ROOT / "models/yolov5n.yaml")
    parser.add_argument("--data", type=str, default=ROOT / "data/tunnelcrack.yaml")
    ...
    parser.add_argument("--evolve_population", type=str, default=ROOT / "data/hyps")
    ...
    parser.add_argument("--name", default="tunnelcrack")
